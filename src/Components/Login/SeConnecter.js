   ...
   return(
      <div className="container-fluide">
         ...
         <div className="row vh-100" >
            <div class="col-xl-7">
               <h1 id="SeConnecter_bienvenue" className="text-center pt-5 display-3 font-weight-bold">
               Bienvenue dans votre<br/>classe vertuelle</h1>
               <Mainsvg />
            </div>
            ...
            <div className="col-xl-5" id="Seconnecter__carte">
               ...
               <div className="row justify-content-around mx-auto px-2">
                  <a class="col-sm-4 text-center text-decoration-none text-center font-weight-bold m-3" id="Seconnecter__signin"  href="#">
                     Se connecter
                  </a>
                  <a class="col-sm-4 text-decoration-none text-white text-center font-weight-bold m-3" id="Seconnecter__signup"  href="#">
                     S'inscrire
                  </a>
               </div>
               ...
               <form className="SeConnecter__form">
                  ...
                  <div className="SeConnecter__form_password">
                        <svg width="33" height="33" viewBox="0 0 35 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0)">
